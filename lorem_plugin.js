(function() {
        ...
        tinymce.create('tinymce.plugins.LoremIpsum', {
                ...
                init : function(ed, url) {
                        ...
                        ed.addCommand('LoremIpsum', function() {
                        ...
                        ed.onNodeChange.add(function(ed, cm, n) {
                                cm.setActive('loremipsum', n.nodeName == 'IMG');
                        });
                },
                ...
                getInfo : function() {
                        return {
                                ...
                                authorurl : 'http://twitter.com/jonnyvaughan/',
                                infourl : 'http://www.10degrees.co.uk/blog/lorem-ipsum-plugin/',
                                version : "1.0"
                        };
                }
        });
